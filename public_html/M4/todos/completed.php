...
*/
$query = "SELECT id,task,due,DATE(completed) AS completed_date, DATEDIFF(completed,due) AS days_offset,assigned FROM todos WHERE is_complete=1 ORDER BY completed DESC, due DESC"; // edit this
$results = [];
try {
